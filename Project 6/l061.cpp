...
vector<vector<Pixel>> grayscale, gx, gy, magnitude, edge, h1, h2, angles, suppression, combined, votes, unrounded_angles, centers;
int height, width;
...
void draw_circle(double r, double cx, double cy)
{
...
void part1(int lower_t, int upper_t, string image, int circle_t)
{
    // reads in image ppm
    ifstream input_ppm;
...
int main(int argc,char* argv[])
{
    ...
    part1(lower_t, upper_t, name, circle_t);
}
